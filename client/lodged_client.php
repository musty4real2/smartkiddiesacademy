...
<h1 class="h1"><img src="../images/icon_bagages.jpg" width="134" height="134" />Lodged Clients</h1>
...
$display";
	...
	echo mysql_num_rows($result)." lodged clients";
...
'#eeeeee'); // Switch the background
 ...
 echo '<tr bgcolor="' . $bg . '">';  ?>
    ...
    <td><?php echo $row['day_spent'];?></td>
    <td><a  title="view record" href="<?php echo 'view_lodge.php?id='.$row['id'];?>"><img src="../images/search voter.gif" width="20" height="20" /></a></td>
    <td>&nbsp;</td>
