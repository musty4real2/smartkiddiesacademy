...
<center><?php echo"<a href='allocate_class.php?id={$_GET['id']}'>Allocate Class</a>" ?>&nbsp;|| <a href="../admin/menu.php" title="go home">Go to Admin Menu</a>|| Entry Date: <?php echo $row['entry_date'];?> </center>
