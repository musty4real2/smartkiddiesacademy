...
<center>
  <h4>Enter CA 1 Test Result Form</h4></center>
<?php
	$ass=$_GET['msg'];
...
$classid=$_GET['classid'];
	...
	if(strlen($score)==0){
		...
		if($score){
			...
			$sql="UPDATE `ca` SET `ca1_test` = '$score' WHERE `status`='1' AND `student_regno`='{$_GET['regno']}' AND `student_id`='{$_GET['id']}'  AND `subject_id`='{$_GET['subid']}' LIMIT 1";
...
He/She Scored $ca1/10</p></center></h1>";
 } ?>
</div></div>
