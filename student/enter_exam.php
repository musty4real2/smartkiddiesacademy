...
<center>
  <h4>Enter Exam Result Form</h4></center>
<?php
	$ass=$_GET['msg'];
...
<tr>
  <td height="51">Enter Exam Score</td><td><input type="text" name="score" size="3" /></td></tr>
...
echo "<h1><center><p class=\"er\">The Score of This Student's Exam on The Selected Subject Has Been Entered !!! Consult Administrators For Help<br/>

He/She Scored $exam/60</p></center></h1>";
 } ?>
</div></div>
